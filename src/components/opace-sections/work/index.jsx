...
const Work = () => {
    const workList2 = [
        ...
        {
            title: 'SkillOspace',
            description: 'A free curated space to learn beginner level skills which you always wated to learn.',
        ...
        {
            title: 'FunOspace',
            description: 'A fun space to relax your nerves by playing some really fun to brain bending games.',
        ...
        {
            title: 'DecentrOspace',
            description: 'A decentralized space where we exit web 2.0 and enter the world of web 3.0',
